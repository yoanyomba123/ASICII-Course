...
### Analysis reports
#
report_timing -from [all_inputs] -max_paths 100 -to [all_registers -data_pins] -slack_lesser_than 100  > reports/fpu.rpt
report_timing -from [all_register -clock_pins] -max_paths 100 -to [all_registers -data_pins]  -slack_lesser_than 100 >> reports/fpu.rpt
report_timing -from [all_registers -clock_pins] -max_paths 100 -to [all_outputs] -slack_lesser_than 100 >> reports/fpu.rpt
report_timing -from [all_inputs] -to [all_outputs] -max_paths 100 -slack_lesser_than 100 >> reports/fpu.rpt
report_timing -from [all_registers -clock_pins] -to [all_registers -data_pins] -delay_type max -slack_lesser_than 100  >> reports/fpu.rpt
report_timing -from [all_registers -clock_pins] -to [all_registers -data_pins] -delay_type min  -slack_lesser_than 100 >> reports/fpu.rpt
#
