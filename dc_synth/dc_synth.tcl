...
set link_library [ list /mnt/class_data/ecec574-w2019/PDKs/SAED32nm_new/SAED32_EDK/lib/stdcell_lvt/db_ccs/saed32lvt_ss0p95v25c.db]
...
reset_design
#create clocK
create_clock -name ideal_clock -period 75 [get_ports gclk]
