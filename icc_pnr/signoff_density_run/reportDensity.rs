...
M2              = assign       ( {{13}} );
M2_metal_blkg   = assign       ( {{13}}, milkyway = { views = {"FRAM"}, cell_types = {MACRO_CELL} }, select_cells = MACRO_CELLS_LIST );
...
M3              = assign       ( {{15}} );
M3_metal_blkg   = assign       ( {{15}}, milkyway = { views = {"FRAM"}, cell_types = {MACRO_CELL} }, select_cells = MACRO_CELLS_LIST );
...
M4              = assign       ( {{17}} );
M4_metal_blkg   = assign       ( {{17}}, milkyway = { views = {"FRAM"}, cell_types = {MACRO_CELL} }, select_cells = MACRO_CELLS_LIST );
...
M5              = assign       ( {{19}} );
M5_metal_blkg   = assign       ( {{19}}, milkyway = { views = {"FRAM"}, cell_types = {MACRO_CELL} }, select_cells = MACRO_CELLS_LIST );
...
M6              = assign       ( {{21}} );
M6_metal_blkg   = assign       ( {{21}}, milkyway = { views = {"FRAM"}, cell_types = {MACRO_CELL} }, select_cells = MACRO_CELLS_LIST );
...
M7              = assign       ( {{23}} );
M7_metal_blkg   = assign       ( {{23}}, milkyway = { views = {"FRAM"}, cell_types = {MACRO_CELL} }, select_cells = MACRO_CELLS_LIST );
...
M8              = assign       ( {{25}} );
M8_metal_blkg   = assign       ( {{25}}, milkyway = { views = {"FRAM"}, cell_types = {MACRO_CELL} }, select_cells = MACRO_CELLS_LIST );
...
M9              = assign       ( {{27}} );
M9_metal_blkg   = assign       ( {{27}}, milkyway = { views = {"FRAM"}, cell_types = {MACRO_CELL} }, select_cells = MACRO_CELLS_LIST );
...
MRDL              = assign       ( {{41}} );
MRDL_metal_blkg   = assign       ( {{41}}, milkyway = { views = {"FRAM"}, cell_types = {MACRO_CELL} }, select_cells = MACRO_CELLS_LIST );
MRDL_macro_rg     = assign       ( {{ 190 }}, { route_guide_layers = {M10_ROUTE_GUIDE}, views = {"FRAM"},  cell_types = {MACRO_CELL} }, select_cells = MACRO_CELLS_LIST );
MRDL_system_blkg  = assign       ( {{ 236 }}, milkyway = { views = {"FRAM"} , cell_types = {MACRO_CELL} }, select_cells = MACRO_CELLS_LIST );
...
MRDL_area_removed = or_list (layers = {MRDL_metal_blkg, MRDL_macro_rg, MRDL_system_blkg});
MRDL_chip_ext = chip_ext not MRDL_area_removed;
MRDL_denLayer = MRDL and MRDL_chip_ext;
layer_name = "M1";
M1_ERROR @= { @"DEN_ERR_M1";
